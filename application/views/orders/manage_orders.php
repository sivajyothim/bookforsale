...
<div class="container">
            ...
            <div class=" col-md-12 col-lg-12 "> 
                  ...
                  <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                                ...
                                <li class="active"><a href="<?php echo base_url(); ?>"><i class="fa fa-book"></i>&nbsp;Manage Orders</a></li>
    ...
    <tr>
        ...
        <td><?php echo ($order_res->order_status ==6)?date('d-M-Y, h:i a',strtotime($order_res->delivered_on)):'--'; ?></td>
        ...
        <?php $sno++; endforeach;else: ?>
            <tr>
                <td colspan="7" class="alert alert-danger text-center">No results found..!</td>
            </tr>
        <?php endif; ?>
