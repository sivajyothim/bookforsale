		...
		<div class="col-md-9">
            ...
            <div class=" col-md-12 col-lg-12 "> 
                  ...
                  <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                                ...
                                <li><a href="javascript:void(0);"><i class="fa fa-edit"></i>&nbsp;Edit</a></li>
                                <li><a href="javascript:void(0);"><i class="fa fa-edit"></i>&nbsp;<?php echo $book_title; ?></a></li>
                        </ul>
                  </nav>
            ...
            <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <br>Note : Numbers are not allowed in description.
                            </div>
            ...
            <div class="col-lg-6 loadingSection"></div>                    
                    ...
                    <button class="btn btn-primary pull-right">Update Book</button>
                    </div>
            </div>
            <!-- Button section end -->
            </form>
