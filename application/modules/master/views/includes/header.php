...
$login_name =fetch_ucfirst($this->session->userdata(ADMIN_SESS_CODE.'username'));
?>
<header class="header">
        <div class="page-brand">
                <a href="<?php echo ADMIN_LINK; ?>">
                    <span class="brand"><img src="<?php echo LOGO_PATH; ?>" alt="" style="height:60px;"></span>
                    <span class="brand-mini"><img src="<?php echo LOGO_PATH; ?>" alt=""></span>
                </a>
            </div>
            <div class="flexbox flex-1">
                ...
                <ul class="nav navbar-toolbar">
                    <li class="timeout-toggler" style="display:none;">
                    ...
                    <li class="dropdown dropdown-inbox" style="display:none;">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-media">
                            ...
                            <div class="p-3">
                                ...
                                <div class="media-list media-list-divider scroller" data-height="350px" data-color="#71808f">
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="<?php echo ADMIN_IMG_PATH;  ?>users/u8.jpg" alt="image" />
                                        </div>
                                    ...
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="<?php echo ADMIN_IMG_PATH;  ?>users/u6.jpg" alt="image" />
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="<?php echo ADMIN_IMG_PATH;  ?>users/u11.jpg" alt="image" />
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="<?php echo ADMIN_IMG_PATH;  ?>users/u10.jpg" alt="image" />
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="<?php echo ADMIN_IMG_PATH;  ?>users/u2.jpg" alt="image" />
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="<?php echo ADMIN_IMG_PATH;  ?>users/u5.jpg" alt="image" />
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="<?php echo ADMIN_IMG_PATH;  ?>users/u9.jpg" alt="image" />
                                        </div>
                                        <div class="media-body">
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            ...
                            <img src="<?php echo ADMIN_IMG_PATH;  ?>users/admin-image.png" alt="image" />
                        </a>
                        <div class="dropdown-menu dropdown-arrow dropdown-menu-right admin-dropdown-menu">
                            ...
                            <div class="dropdown-header">
                                ...
                                <div>
                                    <h5 class="font-strong text-white"><?php echo $login_name; ?></h5>
                            ...
                            <div class="admin-menu-features" style="display:none;">
                            ...
                            <div class="admin-menu-content">
                                <div class="text-muted mb-2" style="display:none;">Your Wallet</div>
                                <div><i class="ti-wallet h1 mr-3 text-light" style="display:none;"></i>
                                    <!-- <span class="h1 text-success"><sup>$</sup>12.7k</span> -->
                                </div>
                                <div class="d-flex justify-content-between mt-2">
                                    <!-- <a class="text-muted" href="javascript:;">Earnings history</a> -->
                                    <a class="d-flex align-items-center" href="<?php echo ADMIN_LINK; ?>Welcome/logout" onclick="return confirm('Confirm to logout ??')">Logout<i class="ti-shift-right ml-2 font-20"></i></a>
                                </div>
                            </div>
                        </div>
                    </li>
