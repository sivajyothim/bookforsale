                ...
                <div class="ibox">
                    <div class="ibox-body">
                        ...
                        <div class="row pull-right">
                            <button  type="button" onclick="activateData(1,'weight');" class="btn btn-success statusActivate">Acive</button>&nbsp;&nbsp;
                  <button type="button" onclick="activateData(0,'weight');" class="btn btn-danger statusActivate">In-active</button>
                        </div>
                        ...
                        <div class="table-responsive row">
                            <table class="table table-bordered table-hover" id="datatable">
                                ...
                                <tbody>
                                <?php
                                $req = json_decode($weight_details);
                                if($req->code == 200){
                                    $sno=1;
                                    foreach($req->weight_result as $res){
                                        $disp_status='';
                                ...
                                ?>
                                <tr>
                               <td> <input type="checkbox" name="multiple[]" class="checkthis" value="<?php echo $res->weight_id; ?>" /></td>
                                ...
                                <td><?php echo $disp_status; ?></td>
                                 <td><a onclick="return confirm('Confirm to delete weight ?')" href="<?php echo ADMIN_LINK; ?>Welcome/deleteweight/<?php echo $res->weight_id; ?>" class="btn btn-sm btn-danger"> Delete</a></td>
                                </tr>
                                <?php $sno++; } } else {?>
								<tr>
                                    <td colspan="4">
