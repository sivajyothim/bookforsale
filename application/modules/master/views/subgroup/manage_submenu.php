                ...
                <div class="ibox">
                    <div class="ibox-body">
                        ...
                        <div class="row pull-right">
                            <button  type="button" onclick="activateData(1,'subgroup');" class="btn btn-success statusActivate">Acive</button>&nbsp;&nbsp;
                  <button type="button" onclick="activateData(0,'subgroup');" class="btn btn-danger statusActivate">In-active</button>
                        </div>
                        ...
                        <div class="table-responsive row">
                            <table class="table table-bordered table-hover" id="datatable">
                                ...
                                <tbody>
                                <?php
                                $req = json_decode($submenu_details);
                                if($req->code == 200){
                                    $sno=1;
                                    foreach($req->submenu_result as $res){
                                        $disp_status='';
                                ...
                                ?>
                                <tr>
                                <td><input type="checkbox" name="multiple[]" class="checkthis" value="<?php echo $res->subgroup_id; ?>" />&nbsp; <?php echo $sno; ?></td>
                                <td><?php echo $res->menu_title; ?></td>
                                <td><?php echo $res->subgroup_title; ?></td>
                                <td><?php echo $res->years; ?> Years</td>
                                <td><?php echo date('d-M-Y h:i A',strtotime($res->created_on)); ?></td>
                                <td><?php echo $disp_status; ?></td>
                                  <td><a onclick="return confirm('Confirm to delete Sub group ?')" href="<?php echo ADMIN_LINK; ?>Welcome/deletesubgroup/<?php echo $res->subgroup_id; ?>" class="btn btn-sm btn-danger"> Delete</a></td>
                                </tr>
                                <?php $sno++; } } else {?>
								<tr>
                                    <td colspan="4">
