...
<body class="fixed-navbar">
                                ...
                                <div class="ibox-body">
                                    <div class="row">
                                        <div class="col-sm-6 form-group mb-4">
                                            <label>Sub Menu Title <sup class="error">*</sup></label>
                                            <input class="form-control" type="text" placeholder="University / College etc.." name="title" id="title" maxlength="60" autocomplete="off"/>
    ...
    $('#create_form').on('submit', function (e) {
        ...
        if (title == 0 || title == '') {  $('#title_error').html('Please enter submenu name');  str = false; }
        ...
        if (str == true)
        {
         ...
         $('.disp_msg').html('Please wait....').css({'color': 'blue'});
            $.ajax({
                ...
                url: "<?php echo ADMIN_LINK; ?>Settings/insertsubmenu",
                contentType: false,
                cache: false,
                processData: false,
                success: function (s) {
                    ...
                    switch (s.code)
                    {
                        case 200:
                            ...
                            $('.disp_msg').html(s.description).css({'color': 'green', 'font-size':
                                        '15px'});
                            setTimeout(function () {
                                window.location = "<?php echo ADMIN_LINK . 'Settings/submenu'; ?>";
                            }, 2000);
