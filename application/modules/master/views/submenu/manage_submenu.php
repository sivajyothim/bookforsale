                ...
                <div class="ibox">
                    <div class="ibox-body">
                        ...
                        <div class="row pull-right">
                            <button  type="button" onclick="activateData(1,'submenu');" class="btn btn-success statusActivate">Acive</button>&nbsp;&nbsp;
                  <button type="button" onclick="activateData(0,'submenu');" class="btn btn-danger statusActivate">In-active</button>
                        </div>
                        ...
                        <div class="table-responsive row">
                            <table class="table table-bordered table-hover" id="datatable">
                                ...
                                ?>
                                <tr>
                                <td><input type="checkbox" name="multiple[]" class="checkthis" value="<?php echo $res->id; ?>" />&nbsp;<?php echo $sno; ?></td>
                                <td><?php echo $res->submenu_title; ?></td>
                                
                                <td><?php echo date('d-M-Y h:i A',strtotime($res->created_on)); ?></td>
                                <td><?php echo $disp_status; ?></td>
                                  <td><a onclick="return confirm('Confirm to delete Submenu ?')" href="<?php echo ADMIN_LINK; ?>Welcome/deletesubmenu/<?php echo $res->id; ?>" class="btn btn-sm btn-danger"> Delete</a></td>
                                </tr>
                                <?php $sno++; } } else {?>
								<tr>
                                    <td colspan="4">
