                               ...
                               <?php
                                    if($productsReq->code==SUCCESS_CODE){ 
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if($product_response->seller_approve_status==1){?>
                                                    <span style="font-weight:bold;color:green">Approved</span>
                                                    <br/>
                                                    <?php echo date('d-M-Y, h:i A',strtotime($product_response->seller_approved_date)); ?>
                                                <?php } else {?>
                                                    <span style="font-weight:bold;color:red">Not-Approved</span>
                                                    <?php } ?></td>
                                                    <td><?php if($product_response->seller_payment_status==1){?>
