...
<body class="fixed-navbar">
                                ...
                                <div class="ibox-body">
                                    <div class="row">
                                        <div class="col-sm-6 form-group mb-4">
                                            <label>Menu Title <sup class="error">*</sup></label>
    ...
    $('#create_form').on('submit', function (e) {
        ...
        if (title == 0 || title == '') {  $('#title_error').html('Please enter menu name');  str = false; }
        ...
        if (str == true)
        {
         ...
         $('.disp_msg').html('Please wait....').css({'color': 'blue'});
            $.ajax({
                ...
                url: "<?php echo ADMIN_LINK; ?>Settings/insertMenu",
                contentType: false,
                cache: false,
                processData: false,
                success: function (s) {
                    ...
                    switch (s.code)
                    {
                        case 200:
                            ...
                            $('.disp_msg').html(s.description).css({'color': 'green', 'font-size':
                                        '15px'});
                            setTimeout(function () {
                                window.location = "<?php echo ADMIN_LINK . 'Settings/menulist'; ?>";
                            }, 2000);
