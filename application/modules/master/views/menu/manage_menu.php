                ...
                <div class="ibox">
                    <div class="ibox-body">
                        ...
                        <div class="row pull-right">
                            <button  type="button" onclick="activateData(1,'menu');" class="btn btn-success statusActivate">Acive</button>&nbsp;&nbsp;
                  <button type="button" onclick="activateData(0,'menu');" class="btn btn-danger statusActivate">In-active</button>
                        </div>
                        ...
                        <div class="table-responsive row">
                            <table class="table table-bordered table-hover" id="datatable">
                                ...
                                if($req->code == 200){
                                    $sno=1;
                                    foreach($req->menu_result as $res){
                                        $disp_status='';
                                ...
                                <td><img style="height:50px;width:50px" src="<?php echo MENU_PATH.$res->menu_picture; ?>" alt="<?php echo $res->menu_title; ?>" title="<?php echo $res->menu_title; ?>"></td>
                                <td><?php echo date('d-M-Y h:i A',strtotime($res->created_on)); ?></td>
                                <td><?php echo $disp_status; ?></td>
                                  <td><a onclick="return confirm('Confirm to delete menu ?')" href="<?php echo ADMIN_LINK; ?>Welcome/deletemenu/<?php echo $res->id; ?>" class="btn btn-sm btn-danger"> Delete</a></td>
                                </tr>
                                <?php $sno++; } } else {?>
								<tr>
                                    <td colspan="8">
