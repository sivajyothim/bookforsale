    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-content fade-in-up">
                <div class="ibox">
                    <div class="ibox-body">
                        <h5 class="font-strong mb-4">Users List</h5>
                        ...
                        <div class="table-responsive row">
                            <table class="table table-bordered table-hover" id="datatable">
                                ...
                                echo $msg;
                             //   echo $user_req;
                                $req = json_decode($user_req);
                                $colspan=7;
                                if($req->code == SUCCESS_CODE){
                                   $sno=1;
                                    foreach($req->user_result as $response){
                                        $username = fetch_ucfirst($response->name);
                                        $id = $response->id;
                                        $link = ADMIN_LINK.'User/profile/'.url_title($username).'/'. base64_encode($id);
                                        $dispstatus = '';
                                        switch($response->status)
                                        {
                                            case 'N':$dispstatus='Not Approved';break;
                                            case 'A':$dispstatus='Approved';break;
                                            case 'IA':$dispstatus='In-active';break;
                                        }
								?>
                                    ...
                                    <tr>
                                        <td><?php echo $sno; ?></td>
                                        <td>
                                            <a href="<?php echo $link; ?>">#<?php echo $id; ?></a>
                                        </td>
                                        <td><?php echo $username; ?></td>
                                        <td><?php echo $response->email; ?></td>
                                        
                                        <td><?php echo $response->mobileno; ?></td>
                                        <td><?php echo date('d-M-Y h:i a',strtotime($response->createddate)); ?></td>
                                        
										<td>
                                            <span class="badge badge-success badge-pill"><?php echo $dispstatus; ?></span>
                                        </td>
										<td>
                                            <a class="text-muted font-16" href="javascript:;"><i class="ti-trash"></i></a>
                                            <a class="font-16 btn btn-sm" href="<?php echo $link; ?>"><i class="fa fa-eye"></i>View</a>
                                        </td>
                                    </tr>
                                <?php } } else { ?>
                                        <tr>
