...
<head>
    ...
    <!-- PLUGINS STYLES-->
    <link href="<?php echo ADMIN_VENDOR_PATH;  ?>jvectormap/jquery-jvectormap-2.0.3.css" rel="stylesheet" />
    <!-- THEME STYLES-->
...
<body class="fixed-navbar">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card mb-4">
                            <div class="card-body flexbox-b">
                                ...
                                <div>
                                    <h3 class="font-strong text-success">0</h3>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card mb-4">
                            <div class="card-body flexbox-b">
                                ...
                                <div>
                                    <h3 class="font-strong text-primary">0</h3>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card mb-4">
                            <div class="card-body flexbox-b">
                                ...
                                <div>
                                    <h3 class="font-strong text-pink">0</h3>
                                    <div class="text-muted">Tomorrow Orders</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- PAGE LEVEL PLUGINS-->
    <script src="<?php echo ADMIN_VENDOR_PATH;  ?>chart.js/dist/Chart.min.js"></script>
    <script src="<?php echo ADMIN_VENDOR_PATH;  ?>jquery.easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
    <script src="<?php echo ADMIN_VENDOR_PATH;  ?>jvectormap/jquery-jvectormap-2.0.3.min.js"></script>
    <script src="<?php echo ADMIN_VENDOR_PATH;  ?>jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <!-- CORE SCRIPTS-->
    <script src="<?php echo ADMIN_JS_PATH;  ?>app.min.js"></script>
    <!-- PAGE LEVEL SCRIPTS-->
    <script src="<?php echo ADMIN_JS_PATH;  ?>scripts/dashboard_visitors.js"></script>
</body>
</html>