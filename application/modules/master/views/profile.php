                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a href="javascript:;"><i class="sidebar-item-icon ti-paint-roller"></i>
                            <span class="nav-label">Approve Details</span><i class="fa fa-angle-left arrow"></i></a>
                        <ul class="nav-2-level collapse in">
                            <li>
                                <a class="active" href="datatables.php">User Data</a>
                            </li>
							<li>
                                <a href="profile.php">Childrens Data 1</a>
                            </li>
							<li>
                                <a href="colors.html">Childrens Data 2</a>
                            </li>
                            <li>
                                <a href="typography.html">Gallary</a>
                            </li>
                            <li>
                                <a href="panels.html">Videos</a>
                            </li>
                            <!--<li>
                                <a href="javascript:;">
						...
						<div class="row">
                            ...
                            <div class="ibox-body">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-6">AP</div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-6 text-muted">Phone:</div>
                                    <div class="col-6">968453</div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-6 text-muted">Email:</div>
                                    <div class="col-6">achari@gmail.com</div>
                                </div>
								</div></div>
							</div>
							<div class="col-lg-7">
